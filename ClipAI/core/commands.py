...
@dataclass(frozen=True)
class UseWorkflowClipboard:
    workflow_id: str
    recovery_id: str


@dataclass(frozen=True)
class ExpireInputRecovery:
    workflow_id: str
    recovery_id: str
...
class EntryPanelInputPreparationCompleted:
    ...
    prepared_input: PreparedInput = field(repr=False)
