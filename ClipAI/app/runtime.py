...
_VOICE_COMMANDS = (OpenVoiceSetup, EnableVoiceInput, DisableVoiceInput, VoiceDisableShutdownCompleted, VoiceDisablePreferenceSaved, VoiceEngineEventReceived, VoicePreferenceSaved, StopVoiceCapture, CancelVoiceCapture, SetVoiceLanguage, VoiceLanguagePreferenceSaved, UpdateVoiceDraft)
